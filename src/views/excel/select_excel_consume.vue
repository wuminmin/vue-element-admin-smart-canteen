...
<div class="block">
    ...
    >
      ...
      <el-table-column label="用餐日期"  align="center">
        <template slot-scope="scope">
          <el-tag>{{ scope.row.用餐日期 }}</el-tag>
        </template>
      </el-table-column>
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      let p = { token: this.token, key: "导出消费清单",value_start:this.value_start,value_end:this.value_end };
